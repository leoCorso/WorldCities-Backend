...
namespace WorldCities.Tests
{
    ...
    {
        [Fact]
        [Description("Tests that we can create users")]
        public async Task CreateDefaultUsers()
        {
            ...
            var controller = new SeedController(context, mockEnv, userManager, roleManager, mockConfiguration.Object);
            ...
            user_NotExisting = await userManager.FindByEmailAsync("notfound@email.com");
